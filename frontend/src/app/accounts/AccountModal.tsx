      ...
      <div className="bg-white p-4 rounded shadow-lg flex-none w-[550px]">
        ...
        <div className="mt-5 flex items-center">
          ...
          <input
            ...
            className={`border p-1 flex-grow rounded-md ${isStatementDirectorySaved ? "border-gray-300" : "border-red-500"}`}
            style={{ outline: 'none' }}
          />
          <button
            onClick={handleSaveStatementDirectory}
            className={clsx("ml-2 px-1 py-2 w-[45px] h-[30px] \
                text-white text-sm rounded \
                flex items-center justify-center",
              isStatementDirectorySaved || isStatementDirectoryLoading ? "bg-gray-400" : "bg-blue-500"
            )}
        ...
        <div className="mt-5 flex items-center">
          ...
          >
            <div
              className={clsx("px-4 py-1 rounded-l",
            ...
            <div
              className={clsx("px-4 py-1 rounded-r",
                !isActive ? "bg-red-500 text-white" : "bg-gray-300 text-gray-500"
              )}
            >
              Inactive
            </div>
