...
class TrendsControllerOverTimeTest < ActionDispatch::IntegrationTest
  test 'should get overTime' do
    ...
    assert json_response.is_a?(Hash), 'Response should be a Hash'
    assert_includes json_response.keys, '2024-07-01', 'Response should include the start of the grouped period'
    assert_includes json_response.keys, '2024-09-01', 'Response should include the end of the grouped period'
  end
